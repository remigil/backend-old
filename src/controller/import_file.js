    ...
    static rmfileops = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await ImportFileOps.destroy({where: {id: id}, transaction: transaction});
                await transaction.commit();
                response(res, true, "Success", "Success");
            }else{
                /**
     ...
     static langgarlantas = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Langgarlantas.destroy({where: {id: Destroy}, transaction: transaction});
                await Langgarlantas.bulkCreate(Data, {transaction: transaction});
                await ImportFileOps.update({status: 1}, {where: {id: source_id}, transaction: transaction});
                await transaction.commit();
                response(res, true, "Success", "Success");
            }else{
                /**
     ...
     static langgarmotor = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Langgarmotor.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static langgarmobil = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Langgarmobil.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static barangbukti = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Barangbukti.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static kendaraanterlibat = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Kendaraanterlibat.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static profesipelaku = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Profesipelaku.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static usia = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Usia.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static simpelaku = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Simpelaku.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static lokasikawasan = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Lokasikawasan.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static statusjalan = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Statusjalan.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static dikmaslantasops = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Dikmaslantasops.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static giatlantas = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Giatlantas.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static lakalantas = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Lakalantas.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static fungsijalan = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Fungsijalan.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static pekerjaankorban = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Pekerjaankorban.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static pekerjaanpelaku = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Pekerjaanpelaku.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static pendidikankorban = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Pendidikankorban.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static penyebaranops = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Penyebaranops.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static ranmorops = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Ranmorops.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static usiakorban = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Usiakorban.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static usiapelaku = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Usiapelaku.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static turjagwaliops = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Turjagwaliops.destroy({where: {id: Destroy}, transaction: transaction});
    ...
    static rmfilentmc = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await ImportFileNtmc.destroy({where: {id: id}, transaction: transaction});
                await transaction.commit();
                response(res, true, "Success", "Success");
            }else{
                /**
     ...
     static programtv = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Programtv.destroy({where: {id: Destroy}, transaction: transaction});
                await Programtv.bulkCreate(Data, {transaction: transaction});
                await ImportFileNtmc.update({status: 1}, {where: {id: source_id}, transaction: transaction});
                await transaction.commit();
                response(res, true, "Success", "Success");
            }else{
                /**
     ...
     static programonline = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Programonline.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static programmedsos = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Programmedsos.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static offairprogram = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Offairprogram.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static mediatv = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Mediatv.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static medsos = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Medsos.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static sosial = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Sosial.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static radio = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Radio.destroy({where: {id: Destroy}, transaction: transaction});
     ...
     static pengaduan = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Pengaduan.destroy({where: {id: Destroy}, transaction: transaction});
    ...
    static rmfilemasy = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await ImportFileMasyarakat.destroy({where: {id: id}, transaction: transaction});
                await transaction.commit();
                response(res, true, "Success", "Success");
            }else{
                /**
     ...
     static kegiatanmasyarakat = async (req, res) => {
        ...
        try {
            ...
            if (valid === true) {
                 ...
                 * Transaction process
                 */
                await Kegiatanmasyarakat.destroy({where: {id: Destroy}, transaction: transaction});
                await Kegiatanmasyarakat.bulkCreate(Data, {transaction: transaction});
                await ImportFileMasyarakat.update({status: 1}, {where: {id: source_id}, transaction: transaction});
                await transaction.commit();
                response(res, true, "Success", "Success");
            }else{
                /**
