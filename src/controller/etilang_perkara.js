...
module.exports = class EtilangPerkaraController {
  static get = async (req, res) => {
    try {
      ...
      const modelAttr = Object.keys(Etilang_perkara.getAttributes());
  ...
  static getId = async (req, res) => {
    try {
      const data = await Etilang_perkara.findOne({
        where: {
  ...
  static add = async (req, res) => {
    ...
    try {
      ...
      await Etilang_perkara.create(fieldValue, { transaction: transaction });
  ...
  static addGeoJson = async (req, res) => {
    ...
    try {
      ...
      const data = await Etilang_perkara.bulkCreate(dummy, {
  ...
  static importExcell = async (req, res) => {
    ...
    try {
      ...
      const ress = await Etilang_perkara.bulkCreate(listPolres, {
        transaction: t,
      });
      await t.commit();
  ...
  static edit = async (req, res) => {
    ...
    try {
      ...
      await Etilang_perkara.update(fieldValue, {
        where: {
          id: AESDecrypt(req.params.id, {
            isSafeUrl: true,
            parseMode: "string",
