...
module.exports = class ExportLapharController {
  static export_laphar = async (req, res) => {
    try {
      ...
      //     media_cetak += parseInt(data.dikmaslantas[j].dataValues.media_cetak);
      //     media_elektronik += parseInt(
      ...
      //     jemensosprek += parseInt(data.penyebaran[j].dataValues.jemensosprek);
      //     jumlah_penyebaran += parseInt(
      ...
      //     bpkb_gantinama += parseInt(data.bpkb[j].dataValues.bpkb_perpanjangan);
      ...
      //     sim_perpanjangan += parseInt(data.sim[j].dataValues.sim_perpanjangan);
      ...
      let results = templateLapharNew(rows);
