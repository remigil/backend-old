...
module.exports = class OperasiProfesiController {
    ...
    try {
      ...
      let getDataRules = {
        ...
        attributes: [
          ...
          [
            Sequelize.fn("sum", Sequelize.col("mahasiswa_pelajar")),
            "mahasiswa_pelajar",
          ],
          ...
          [
            Sequelize.literal(
              "SUM(pns + karyawan + tni + polri + mahasiswa_pelajar + pengemudi + lain_lain)"
            ),
            "total",
          ],
        ],
      ...
      finals.map((element, index) => {
        rows.push({
          ...
          mahasiswa_pelajar:
            parseInt(element.dataValues.mahasiswa_pelajar) || 0,
      ...
      if (type === "day") {
        const asd = list_day.map((item, index) => {
          ...
          if (data) {
            finals.push({
              ...
              mahasiswa_pelajar: parseInt(data.dataValues.mahasiswa_pelajar),
        ...
        let abc = rows.map((element, index) => {
          return {
            ...
            mahasiswa_pelajar: parseInt(element.dataValues.mahasiswa_pelajar),
        ...
        const asd = list_month.map((item, index) => {
          ...
          if (data) {
            finals.push({
              ...
              mahasiswa_pelajar: parseInt(data.mahasiswa_pelajar),
  ...
  //           tni: item.tni,
  //           polri: item.polri,
  //           mahasiswa_pelajar: item.mahasiswa_pelajar,
  ...
  //         mahasiswa_pelajar: req.body.mahasiswa_pelajar,
