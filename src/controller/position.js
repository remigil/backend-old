...
module.exports = class PositionController {
  static get = async (req, res) => {
    try {
      ...
      const modelAttr = Object.keys(Position.getAttributes());
      ...
      const data = await Position.findAll(getData);
  ...
  static add = async (req, res) => {
    ...
    try {
      ...
      let op = await Position.create(fieldValueData, {
  ...
  static edit = async (req, res) => {
    ...
    try {
      ...
      await Position.update(fieldValueData, {
        where: {
          id: AESDecrypt(req.params.id, {
            isSafeUrl: true,
            parseMode: "string",
